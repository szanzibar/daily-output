defmodule SprachjournalWeb do
  ...
  This can be used in your application as:
      ...
      use SprachjournalWeb, :controller
  ...
  defp html_helpers do
    quote do
      ...
      alias SprachjournalWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: SprachjournalWeb.Router,
        statics: SprachjournalWeb.static_paths()
    end
  end
